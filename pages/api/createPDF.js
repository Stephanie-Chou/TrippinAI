  ...
  neighborhoods: [
    {
      ...
      image: {
        urls:  { regular: 'https://images.unsplash.com/photo-1665236494140-db0fbf7309ac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjM2MDh8MHwxfHNlYXJjaHwxfHxUb2t5byUyMEFzYWt1c2F8ZW58MHwwfHx8MTY4NzQ3MjkwNnww&ixlib=rb-4.0.3&q=80&w=1080'}
      }
    },
    {
      name:'Manhattan',
...
export default async function (req, res) {
  ...
  // const { city, neighborhoods, activities, foods, dayTrips } = (await req.json()) 
  const { city, neighborhoods, activities, foods, dayTrips } = sampleData;
